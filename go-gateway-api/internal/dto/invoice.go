...
// CreateInvoiceInput representa os dados de entrada para criar uma nova fatura
...
// InvoiceOutput representa os dados de saída após manipular uma fatura
...
// FromInvoice converte um objeto Invoice para InvoiceOutput
